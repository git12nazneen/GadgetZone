...
const Review = () => {
  const reviews = [
    {
      ...
      time: '2 days ago',
      rating: '4.5',
      content: 'Vivamus sit amet turpis leo. Praesent varius eleifend elit, eu dictum lectus consequat vitae. Etiam ut dolor id justo fringilla finibus.',
      color: 'bg-black',
    ...
    },
    {
      ...
      time: '1 week ago',
      rating: '4.8',
      content: 'Donec eget ultricies diam, eu molestie arcu. Etiam nec lacus eu mauris cursus venenatis. Maecenas gravida urna vitae accumsan feugiat.',
      color: 'bg-orange-600',
      textColor: 'text-white',
    ...
    },
    {
      ...
      time: '1 month ago',
      rating: '4.2',
      content: 'Vestibulum commodo, ante sit urna purus rutrum sem. Nulla facilisi. Ut euismod mi vitae justo ultrices, eu gravida turpis fermentum.',
      color: 'bg-black',
      textColor: 'text-white',
  ...
  return (
    ...
    <div className="flex space-x-4 justify-center p-6">
      ...
      {reviews.map(review => (
        <div key={review.id} className={`w-80 p-4 rounded-md ${review.color} ${review.textColor} flex flex-col space-y-4`}>
